...
class Shot2:  # クライアント側(送信側の処理)
    ...
    def draw(self):
        ...
        image_fighter2 = pygame.image.load('src/fighter1.png')
        image_fighter1 = pygame.image.load('src/fighter2.png')
        image_bullet2 = pygame.image.load('src/bullet1.png')
        image_bullet1 = pygame.image.load('src/bullet2.png')
        ...
        fighter2 = image_fighter1.get_rect()
        fighter1 = image_fighter2.get_rect()
        ...
        fighter1.center = (400, 600)
        fighter2.center = (200, 600)
